...
namespace FestivalAPI.Controllers
{
    ...
    public class FestivalsController : ControllerBase
    {
        ...
        {
            return await _context.Festival.Include("Artistes").Include("Hebergements").Include("Organisateurs").Include("Festivaliers").Include("Festival_Artistes").Include("Scenes").Include("Jours").ToListAsync();
        }
        ...
        {
            var festival = await _context.Festival.Include("Artistes").Include("Hebergements").Include("Organisateurs").Include("Festivaliers").Include("Festival_Artistes").Include("Scenes").Include("Jours").FirstOrDefaultAsync(f => f.IdF == id); 
