...
namespace FestivalAPI.Controllers
{
    ...
    public class ArtistesController : ControllerBase
    {
        ...
        {
            return await _context.Artiste.Include("Festival_Artistes").ToListAsync();
        }
        ...
        {
            var artiste = await _context.Artiste.Include("Festival_Artistes").FirstOrDefaultAsync(f => f.IdA == id); ;
